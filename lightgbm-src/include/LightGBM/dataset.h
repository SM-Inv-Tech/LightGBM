...
namespace LightGBM
{
    ...
    */
    ...
    public:
        ...
        */
        inline const label_t *label() const
        { return label_.data(); }
        ...
        */
        inline data_size_t num_queries() const
        { return num_queries_; }
        ...
        */
        inline int64_t num_init_score() const
        { return num_init_score_; }
    ...
    */
    ...
    public:
        ...
        */
        ...
        inline int num_numeric_features() const
        { return num_numeric_features_; }

        /*! \brief Get Number of feature groups */
        inline int num_feature_groups() const
        { return num_groups_; }

        /*! \brief Get Number of total features */
        inline int num_total_features() const
        { return num_total_features_; }

        /*! \brief Get the index of label column */
        inline int label_idx() const
        { return label_idx_; }
        ...
        inline const std::string parser_config_str() const
        ...
        inline bool wait_for_manual_finish() const
        { return wait_for_manual_finish_; }
        ...
        /*! \brief Set has_raw_ */
        inline void SetHasRaw(bool has_raw)
        { has_raw_ = has_raw; }
