    ...
    */
    ...
    public:
        ...
        */
        ...
        virtual double BoostFromScore(int /*class_id*/) const
        { return 0.0; }

        virtual bool ClassNeedTrain(int /*class_id*/) const
        { return true; }
        ...
        virtual data_size_t NumPositiveData() const
        { return 0; }
        ...
        */
        virtual bool IsCUDAObjective() const
        { return false; }
